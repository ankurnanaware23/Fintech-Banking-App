            ...
            <header className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {isLoggedIn ? (
                        <button onClick={handelLogout} className="hidden md:inline-flex items-center justify-center rounded-2xl bg-gray-900 px-4 py-2.5 text-sm font-medium text-white shadow-sm transition hover:opacity-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-300 dark:bg-white dark:text-black dark:focus-visible:ring-white/15">
                            Logout
                        </button>
                        ):(
